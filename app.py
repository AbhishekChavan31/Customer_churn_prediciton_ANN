...
with open('label_underscore_gender.pkl', 'rb') as file:
...
geo_encoded_value = onehot_encoder.transform([[geography]]).toarray()
geo_encoded_df = pd.DataFrame(geo_encoded_value, columns=onehot_encoder.get_feature_names_out(['Geography']))
